...
package com.yitusite.buflo.admin.common.util;
 ...
 * @date 2017/10/29
 */
public class BufloResourcesGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://buflo-mysql:3306/buffalo?characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false");
        ...
        strategy.setInclude(new String[] { "shop_user" }); // 需要生成的表
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.yitusite.shop.member");
