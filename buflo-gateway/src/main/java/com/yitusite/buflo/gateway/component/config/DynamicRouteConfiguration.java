...
public class DynamicRouteConfiguration {
    ...
    @Bean
    public com.yitusite.buflo.gateway.component.config.DynamicRouteLocator dynamicRouteLocator() {
        return new com.yitusite.buflo.gateway.component.config.DynamicRouteLocator(server.getServletPrefix()
                , discovery
                , zuulProperties
                , registration
                , redisTemplate);
