package com.yitusite.bufloauth.feign;

import com.yitusite.bufloauth.feign.fallback.UserServiceFallbackImpl;
 ...
 * @date 2017/10/31
 */
@FeignClient(name = "buflo-upms-service", fallback = UserServiceFallbackImpl.class)
